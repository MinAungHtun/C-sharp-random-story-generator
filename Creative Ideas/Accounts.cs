...
namespace Creative_Ideas
{
    public partial class Accounts : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'creativeIdeasDataSet2.AccountType' table. You can move, or remove it, as needed.
            this.accountTypeTableAdapter.Fill(this.creativeIdeasDataSet2.AccountType);
            // TODO: This line of code loads data into the 'creativeIdeasDataSet2.Account' table. You can move, or remove it, as needed.
            this.accountTableAdapter.Fill(this.creativeIdeasDataSet2.Account);
            this.TopMost = true;
        ...
        {
            this.accountBindingSource.RemoveCurrent();
