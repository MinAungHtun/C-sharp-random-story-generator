...
{
    public partial class Motive : Form
    {
        ...
        private void Motive_Load(object sender, EventArgs e)
        {
           
            // TODO: This line of code loads data into the 'creativeIdeasDataSet2.Motive' table. You can move, or remove it, as needed.
            this.motiveTableAdapter.Fill(this.creativeIdeasDataSet2.Motive);
            this.TopMost = true;
        ...
        private void motiveBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            try
            {
                this.Validate();
                this.motiveBindingSource.EndEdit();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            this.motiveBindingSource.AddNew();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            this.motiveBindingSource.RemoveCurrent();
